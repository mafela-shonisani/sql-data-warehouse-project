...
This script creates the Bronze layer tables used
to store raw CRM and ERP data imported from source
systems. Existing tables are dropped and recreated
to ensure a clean environment before loading data.
